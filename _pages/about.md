...
<p style="color:indianred;">每年招收机械硕士和（直/普）博士研究生；目前有博士后空缺，训练性课题支持本科生参与科研活动，欢迎<li><a href="mailto:daizh@pku.edu.cn"><i class="fas fa-fw fa-envelope" aria-hidden="true"></i>邮件</a></li>或前往<li><i class="fa fa-fw fa-map-marker" aria-hidden="true"></i> 新奥工学大楼420</li>讨论。</p>
