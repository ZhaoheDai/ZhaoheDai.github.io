...
<p style="color:indianred;">每年招收机械硕士和（直/普）博士研究生；目前有博士后空缺，训练性课题支持本科生参与科研活动，欢迎<a href="mailto:daizh@pku.edu.cn"><i class="fas fa-fw fa-envelope" aria-hidden="true" style="color:indianred"></i>邮件</a>或前往<i class="fa fa-fw fa-map-marker" aria-hidden="true" style="color:indianred">新奥工学大楼420</i>讨论。</p>
